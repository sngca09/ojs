<%@ Page Title="" Language="C#" MasterPageFile="~/AuthorMaster.master" AutoEventWireup="true" CodeFile="Contact1.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	<header id="head" class="secondary">
            <div class="container">
                    <h1>Contact Us</h1>
                    <p> door is always open to you</p>
                </div>
    </header>
	...
	<div class="container">
				<div class="row">
					<div class="col-md-8">
						...
						<p>
					 please fill the below columns for send your message to us.
						</p>
