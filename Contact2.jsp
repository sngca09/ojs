<%-- 
    Document   : Contact1
    Created on : Jan 28, 2017, 3:25:01 PM
    Author     : Asha
--%>
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right mainNav">
					 <li> <a href="User_Profile.jsp">My Home</a></li>
                                        <li ><a href="User_Contents.jsp">Research Areas</a></li>
                                       	<li><a href="About1.jsp">About</a></li>
                                        <li  class="active"><a href="Contact2.jsp">Contact</a></li>
					...
					<div class="col-md-8">
						...
						Lorem Ipsum is inting and typesetting in simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the is dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
							...
							<div class="form-group">
								<label>Name</label>
                                                                <input type="text" class="form-control" name="name" placeholder="Your name" pattern="[A-Za-z]+" required>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
							...
							<div class="form-group">
								<label>Subject</label>
                                                                <input type="text" class="form-control" placeholder="Subject" name="subject" pattern="[A-Za-z]+" required>
							</div>
							<div class="form-group">
								<label>Message</label>
                                                                <textarea class="form-control" id="message" name="message" placeholder="Write you message here..." style="height:100px;" required></textarea>
							</div>
							<button type="submit" name="send" class="btn btn-two">Send message</button><p><br/></p>
						</form>
					</div>
					<div class="col-md-4">
						<div class="row">
...
if(request.getParameter("send")!=null)
{
    ...
    String s="insert into feedback values(0,'"+name+"','"+subject+"','"+message+"','"+email+"','"+phone+"','Customer')";
